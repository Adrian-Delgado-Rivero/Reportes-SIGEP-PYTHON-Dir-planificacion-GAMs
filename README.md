...
(1) PRINCIPAL
DATOS PRINCIPALES (Merge Base + Diccionario)																				
...
(3) TABLA FILTRADA
TABLA FILTRADA (Post-filtros)																												
Entidad	TIPO	DA	UE	FTE	Org.	Cat. Prg.	Descripción Cat. Prg.	Objeto	Descripcion Objeto Del Gasto	Presupuesto Inicial	Mod. Aprobadas	Presup. Vig.	Preventivo	Diff_Vig_Prev	Compromiso	Devengado	Pagado	Saldo Por Pagar	Porcen.	Saldo Deveng.	Diferencia Vig-Prev	Var_Multiple_FTE	FTE_2	FTE_3	Var_Multiple_Org	Org_2	Org_3	Concat_Org
...
#FINALIDAD#
Al usar **SALDOS Obj** se obtendra partidas presupuestaria que pueden ser modificadas en la reformulaciones de los POAs dentro cada municipio, 
siguiendo los filtros de:
1. Org financiadora
2. Gastos recurrentes
3. Gastos asignados por ley
